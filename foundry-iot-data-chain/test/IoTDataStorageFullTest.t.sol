...
contract IoTDataStorageFullTest is Test {
    IoTDataStorageFull private iotDataStorage;
    ...
    function setUp() public {
        ...
        vm.prank(owner);
        iotDataStorage = new IoTDataStorageFull();
    }
    ...
    function testStorageModeIsFullStorage() public view {
        assertEq(iotDataStorage.getStorageMode(), "full-storage");
    }
    ...
    function testOwnerCanRegisterDevice() public {
        ...
        IoTDataStorageFull.Device memory registeredDevice = iotDataStorage.getDevice(device);
    ...
    function testNonOwnerCannotRegisterDevice() public {
        ...
        vm.expectRevert(IoTDataStorageFull.IoTDataStorage__NotOwner.selector); // prendo il selector dell'error (come selector funzione)
        iotDataStorage.registerDevice(device, METADATA_URI);
    }
    ...
    function testCannotRegisterSameDeviceTwice() public {
        ...
        vm.prank(owner);
        vm.expectRevert(IoTDataStorageFull.IoTDataStorage__DeviceAlreadyRegistered.selector);
        iotDataStorage.registerDevice(device, METADATA_URI);
    }
    ...
    function testRegisteredDeviceCanRecordMeasurement() public {
        ...
        IoTDataStorageFull.Measurement memory measurement = iotDataStorage.getMeasurement(device, 0);
    ...
    function testUnregisteredDeviceCannotRecordMeasurement() public {
        vm.expectRevert(IoTDataStorageFull.IoTDataStorage__DeviceNotRegistered.selector);
    ...
    function testCanGetLatestMeasurement() public {
        ...
        IoTDataStorageFull.Measurement memory latestMeasurement = iotDataStorage.getLatestMeasurement(device);
    ...
    function testCannotRecordMeasurementWithInvalidSignature() public {
        ...
        vm.prank(user);
        vm.expectRevert(IoTDataStorageFull.IoTDataStorage__InvalidSignature.selector);
    ...
    function testCannotReuseNonce() public {
        ...
        vm.prank(user);
        vm.expectRevert(IoTDataStorageFull.IoTDataStorage__InvalidNonce.selector);
