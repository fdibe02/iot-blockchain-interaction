...
contract IoTDataStorageLatestTest is Test {
    IoTDataStorageLatest private iotDataStorage;
    ...
    function setUp() public {
        ...
        vm.prank(owner);
        iotDataStorage = new IoTDataStorageLatest();
    }
    ...
    function testStorageModeIsLatestStorage() public view {
        assertEq(iotDataStorage.getStorageMode(), "latest-storage");
    }
    ...
    function testOwnerCanRegisterDevice() public {
        ...
        IoTDataStorageLatest.Device memory registeredDevice = iotDataStorage.getDevice(device);
    ...
    function testNonOwnerCannotRegisterDevice() public {
        ...
        vm.expectRevert(IoTDataStorageLatest.IoTDataStorage__NotOwner.selector); // prendo il selector dell'error (come selector funzione)
        iotDataStorage.registerDevice(device, METADATA_URI);
    }
    ...
    function testCannotRegisterSameDeviceTwice() public {
        ...
        vm.prank(owner);
        vm.expectRevert(IoTDataStorageLatest.IoTDataStorage__DeviceAlreadyRegistered.selector);
        iotDataStorage.registerDevice(device, METADATA_URI);
    }
    ...
    function testRegisteredDeviceCanRecordMeasurement() public {
        ...
        IoTDataStorageLatest.Measurement memory measurement = iotDataStorage.getLatestMeasurement(device);
    ...
    function testUnregisteredDeviceCannotRecordMeasurement() public {
        vm.expectRevert(IoTDataStorageLatest.IoTDataStorage__DeviceNotRegistered.selector);
    ...
    function testCannotRecordMeasurementWithInvalidSignature() public {
        ...
        vm.prank(user);
        vm.expectRevert(IoTDataStorageLatest.IoTDataStorage__InvalidSignature.selector);
    ...
    function testCannotReuseNonce() public {
        ...
        vm.prank(user);
        vm.expectRevert(IoTDataStorageLatest.IoTDataStorage__InvalidNonce.selector);
